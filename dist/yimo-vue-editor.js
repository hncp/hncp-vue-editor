(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("YimoVueEditor", [], factory);
	else if(typeof exports === 'object')
		exports["YimoVueEditor"] = factory();
	else
		root["YimoVueEditor"] = factory();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_wangEditor_js__ = __webpack_require__(3);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    renderEditor: function renderEditor() {
      ...
      editor.config.lang = __WEBPACK_IMPORTED_MODULE_1__assets_js_wangEditor_js___default.a.langs["en"];
      //日志配置
...
(function(factory) {
  ...
  E.websiteHost =
    "wangeditor.github.io|www.wangeditor.com|wangeditor.coding.me";
  ...
  function initPlugins(_e) {
    ...
    _e(function(E, $) {
      ...
      MenuContainer.fn._addGroup = function(groupIdx) {
        ...
        if (!this.$currentGroup || this.currentGroupIdx !== groupIdx) {
          $menuGroup = $(
            '<div class="menu-group clearfix" style="clear:none !important;"></div>'
          );
      ...
      MenuContainer.fn._addOneMenu = function(menu) {
        ...
        var $item = $(
          '<div class="menu-item clearfix" style="clear:none !important;"></div>'
        );
        $menuSelected.hide();
    ...
    _e(function(E, $) {
      ...
      var Menu = function(opt) {
        ...
        this.commandValueSelected =
          opt.commandValueSelected || opt.commandValue;
      };
    ...
    _e(function(E, $) {
      ...
      function linkContentHandler(editor, menu, $linkContent) {
        var lang = editor.config.lang;
        var $urlContainer = $(
          '<div style="margin:20px 10px 10px 10px;"></div>'
        );
        var $urlInput = $(
    ...
    _e(function(E, $) {
      E.createMenu(function(check) {
        ...
        var $linkInput = $(
          '<input type="text" class="block" placeholder=\'url：<iframe src="..." frameborder=0 allowfullscreen></iframe>\'/>'
        );
        ...
        $btnSubmit.click(function(e) {
          ...
          if (!reg.test(link)) {
            alert("The video link format is wrong!");
            menu.dropPanel.focusFirstInput();
            return;
          }

          if (isNaN(width) || isNaN(height)) {
            alert("Width or height is not a number!");
            return;
          }
      ...
      E.plugin(function() {
        ...
        $txt.on("paste", function(e) {
          ...
          if (items) {
            ...
            E.log(
              "粘贴前，检查到编辑器有" + $imgsBeforePaste.length + "个图片"
            );
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Editor__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_wangEditor_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_wangEditor_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__assets_js_wangEditor_js__);
...
const instance = __WEBPACK_IMPORTED_MODULE_0__Editor__["a" /* default */];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Editor_vue__ = __webpack_require__(2);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9a98a034_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Editor_vue__ = __webpack_require__(19);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9a98a034_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Editor_vue__["a" /* default */],
...
var update = __webpack_require__(1)("603fa850", content, true, {});
...
// module
exports.push([module.i, ".yimo-vue-editor{width:100%;height:auto!important;min-height:300px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("f800c1e2", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"yimo-vue-editor",attrs:{"id":_vm.editorId}})}
var staticRenderFns = []
...
//# sourceMappingURL=yimo-vue-editor.js.map